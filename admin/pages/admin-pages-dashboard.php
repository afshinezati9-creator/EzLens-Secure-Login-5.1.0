...
class EzLens_Auth_Admin {
    ...
    public function render_product_options() {
        ...
        if ($action === 'edit') {
            $editor_file = EZLAUTH_MODULES_DIR . 'product-options/admin/pages/editor/index.php';
        ...
        $list_file = EZLAUTH_MODULES_DIR . 'product-options/admin/pages/list/index.php';
    ...
    public function render_product_options_settings() {
        $settings_file = EZLAUTH_MODULES_DIR . 'product-options/admin/pages/settings/index.php';
        if (file_exists($settings_file)) {
            include $settings_file;
            if (function_exists('ezlens_po_render_settings_page')) {
                ezlens_po_render_settings_page();
            } elseif (class_exists('EzLens_PO_Settings_Page')) {
                EzLens_PO_Settings_Page::render();
            }
        } else {
            echo '<div class="wrap"><h1>تنظیمات ویژگی‌های محصول</h1><p style="color:#dc2626;">فایل تنظیمات یافت نشد.</p></div>';
        }
    }
